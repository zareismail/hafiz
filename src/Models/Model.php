...
use Zareismail\Maintenable\Contracts\Maintenable;


class Model extends LaravelModel implements MoreDetails, HasMedia, Costable, Reportable, Contractable, Recipient, Maintenable
{
